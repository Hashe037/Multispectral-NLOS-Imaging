function[brdf,brdf_inc_angs,brdf_scat_angs,brdf_scat_range,vectors_remove,vector_num] ...
    = expandBrdfParams(brdf_params)

vector_num = brdf_params.vector_num; %how many SVD vectors to use
vectors_remove = brdf_params.vectors_remove; %which (if any) SVD vectors to ignore
